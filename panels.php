...
THEVERYENDOFYOU;
     ...
     *
     * Babble box | Status: Not moved
     * Who's online  | Status: Moved to Eloquent
     * Template | Status: Not Moved
     * @return mixed
     */
    function panelright()
    {
        ...
        // Babblebox - grab from index.php babblebox
    ...
    // @TODO Move to template - Mostly moved
    ...
    function panelbottom()
    {
        ...
        if ($userrow["levelup"] > 0) {
            $row["levelup"] = "<a href=\"users.php?do=levelup\" class=\"red\">(" . $userrow["levelup"] . " LP)</a>";
        } else {
            $row["levelup"] = "";
        }
        if ($userrow["levelspell"] > 0) {
            $row["levelspell"] = "<a href=\"users.php?do=levelspell\" class=\"blue\">(" . $userrow["levelspell"] . " SP)</a>";
        } else {
            $row["levelspell"] = "";
        }
